...
function fig = createWindow()
	...
	sliders = gobjects(1, 10);
	%prealocando o vetor que contem os textos dos sliders:
	freqTexts = gobjects(1, 10);
	%strings que os textos terao:
	freqTextStrings = {'31.25Hz', '62.5 Hz', '125 Hz', '250 Hz', '500 Hz', ...
		'1 kHz' '2 kHz', '4 kHz', '8 KHz', '16 kHz'};
	% strings dos ganhos:
	gainTexts = gobjects(1, 10);
	dBTexts = gobjects(1, 10);
	% esse for cria os 10 sliders do eq grafico
	for i=1:10
		sliders(i) = uicontrol( ...
			'Style', 'slider', ...
			'Parent', panel, ...
			'Position', [25+70*(i-1) 10 20 150], ...
		...
		freqTexts(i) = uicontrol( ...
			'Style', 'text', ...
			'Parent', fig, ...
			'Position', [panel.Position(1)+5+70*(i-1) 5 60 15], ...
	...
	uicontrol( ...
		'Style', 'pushbutton', ...
		'Parent', fig, ...
		'Position', [450 fig.Position(4)-45 100 30], ...
		'String', 'Tocar', ...
	...
	uicontrol( ...
		'Style', 'pushbutton', ...
		'Parent', fig, ...
		'Position', [755 fig.Position(4)-100 40 20], ...
		'String', 'Reset', ...
	...
	%cria texto que diz a musica atual
		uicontrol( ...
			'Style', 'text', ...
			'Parent', fig, ...
			'Position', [50 fig.Position(4)-70 100 20], ...
			'String', 'Arquivo Atual:' ...
		);
		nomeArq = uicontrol( ...
			'Style', 'text', ...
			'Parent', fig, ...
			'Position', [150 fig.Position(4)-70 600 20], ...
			'String', 'nenhum', ...
...
function tocar(sinal, Fs, ganhos, playButton)
	...
	sinalEqualizado = EQgrafico(Fs, sinal, ganhos);
